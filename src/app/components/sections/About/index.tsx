...
const About = () => {
  return (
    <section className="bg-grey min-h-[700px] md:min-h-[800px] flex items-center px-6 md:px-0">
      <div className="container mx-auto px-2 flex flex-col md:flex-row items-center justify-center md:gap-16 lg:gap-24">
        <div className="max-w-fit ml-auto">
          ...
          <h2 className="text-2xl lg:text-3xl font-bold my-2">
            Connect with your
            <br />
          ...
          <p className=" max-w-lg text-xl mt-6 mb-8">
            {
